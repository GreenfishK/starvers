\begin{table}
    \centering
    \begin{tabular}{p{0.09\textwidth}c|c|c|c|c|c|c|c|c|c|c|c|c|c}
        &  & \multicolumn{4}{c|}{BEARB\_day} & \multicolumn{4}{c|}{BEARB\_hour} & \multicolumn{4}{c}{BEARC} \\
        \cline{3-14} 
        & & Raw  & GraphDB  & Jena & Ostrich  & Raw  & GraphDB  & Jena & Ostrich & Raw  & GraphDB  & Jena & Ostrich  \\                                                        
        \hline
    \multicolumn{1}{c|}{\multirow{4}{*}{\rotatebox{90}{\parbox{2.0cm}{\centering Storage\\consumption\\in GiB}}}} & cb\_ng & {{sotrage_consumption_cb_sr_ng}}   \\
        ...
        \multicolumn{1}{c|}{}  & tb\_rs  & {{sotrage_consumption_ostrich}}   \\
    ...
    \multicolumn{1}{c|}{}   & tb\_rs  & {{ingestion_time_ostrich}}   \\
    \end{tabular}
