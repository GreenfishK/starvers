...
############################################# Logging #############################################
with open(f'{os.environ["RUN_DIR"]/output/logs/preprocess_data/parse_sciqa_queries.txt', "w") as log_file:
    log_file.write("")
with open(f'{os.environ["RUN_DIR"]/output/logs/preprocess_data/excluded_queries.csv', "w") as query_log_file:
...
def exclude_queries():
    ...
    with open(f'{os.environ["RUN_DIR"]/output/logs/preprocess_data/excluded_queries.csv', "a") as query_log_file:
        for row in queries:
