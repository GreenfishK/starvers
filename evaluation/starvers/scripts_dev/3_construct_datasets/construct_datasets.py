...
def construct_tb_star_ds_from_files(source_ic0: str, source_cs: str, destination: str,
...
def construct_tb_star_ds(source_ic0: str, source_cs: str, destination: str, 
    ...
    subprocess.call(shlex.split(f"{mgmt_script} --log-file {LOG_FILE} dump_repo {database_dir} {policy} {dataset} {destination}"))
