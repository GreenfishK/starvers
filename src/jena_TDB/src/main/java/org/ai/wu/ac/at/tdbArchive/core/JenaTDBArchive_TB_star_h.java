...
public class JenaTDBArchive_TB_star_h implements RDFArchive {
	private static final Logger logger = LogManager.getLogger(JenaTDBArchive_TB_star_h.class);
	...
	public JenaTDBArchive_TB_star_h() {
