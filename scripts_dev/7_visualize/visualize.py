...
def create_plots(dataset: str, query_set: str):
    ...
    fig.suptitle(f"Query performance and data ingestion & storage plots for {dataset} and {query_set}", fontsize=32)
    fig.set_figheight(9)
    fig.set_figwidth(16)
...
def create_plots2(triplestore: str, dataset: str):
    """
    ...
    query_sets.to_csv("/starvers_eval/output/figures/query_sets.csv")
