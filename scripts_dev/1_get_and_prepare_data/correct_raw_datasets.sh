    ...
    for policy in ${policies[@]}; do
        ...
        if [ "$dataset" == "beara" ]; then
            ...
            do
                ...
                /jena-fuseki/tdbloader2 --loc ${baseDir}/databases/preprocessing/jenatdb2_${policy}_${dataset}/${repositoryID} $ds_abs_path 2>> $baseDir/output/logs/invalid_triples_${repositoryID}.txt
