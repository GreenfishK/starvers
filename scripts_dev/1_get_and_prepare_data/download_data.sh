...
> /starvers_eval/rawdata/bearb_hour/empty.nt # for CB policy: empty initial delete changeset
...
> /starvers_eval/rawdata/bearb_day/empty.nt # for CB policy: empty initial delete changeset
