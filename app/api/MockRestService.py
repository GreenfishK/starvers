...
tag_metadata = {
    "name": tag,
    "description": "Mock endpoint which returns a modified snippet of dbpedia knowledge graph which updates every nanosecond to simulate fast changing data",
}
...
sparql_router = SparqlRouter(
    ...
    description="A SPARQL endpoint to servemock data to test/evaluate polling tasks",
    version="0.1.0"
)
