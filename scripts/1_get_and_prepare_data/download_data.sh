...
tar -xf ~/.BEAR/rawdata/beara/alldata.IC.nt.tar.gz -C ~/.BEAR/rawdata/beara/alldata.IC.nt.tar.gz
...
tar -xf ~/.BEAR/rawdata/bearb-hour/alldata.IC.nt.tar.gz -C ~/.BEAR/rawdata/bearb-hour/alldata.IC.nt.tar.gz
...
tar -xf ~/.BEAR/rawdata/bearb-day/alldata.IC.nt.tar.gz -C ~/.BEAR/rawdata/bearb-day/alldata.IC.nt.tar.gz
...
tar -xf ~/.BEAR/rawdata/bearc/alldata.IC.nt.tar.gz -C ~/.BEAR/rawdata/bearc/alldata.IC.nt.tar.gz
