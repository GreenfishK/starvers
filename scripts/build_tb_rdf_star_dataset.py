...
computed_change_sets_dir = "alldata.CB_computed.nt"
tb_star_dataset_filename = "alldata.TB_star.ttl"
add_only_first_x_change_sets = 1299
...
def construct_change_sets(end_vers: int):
...
def construct_tb_star_ds(cb_rel_path: str, last_change_set: int):
    """
    ...
    output_path = dataset_dir + "/" + tb_star_dataset_filename
...
construct_change_sets(add_only_first_x_change_sets)
construct_tb_star_ds(computed_change_sets_dir, add_only_first_x_change_sets)
